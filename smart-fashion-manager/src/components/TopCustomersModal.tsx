...
import { printInCurrentDocument } from '../utils/printWindowHelper';
import {
  Trophy,
  Search,
  X,
...
export const TopCustomersModal: React.FC<TopCustomersModalProps> = ({
  ...
  const handlePrintRanking = () => {
    ...
    const fullReportHtml = `
      <div style="font-family: 'Poppins', sans-serif; padding: 20px; color: #0f172a; background: white; width: 100%;">
        <div style="text-align: center; border-bottom: 2px solid #0f172a; padding-bottom: 12px; margin-bottom: 20px;">
          <h1 style="margin: 0; font-size: 22px; text-transform: uppercase; letter-spacing: 1px; font-weight: 700;">🏆 ${storeName} - TOP CUSTOMER ANALYTICS</h1>
          <p style="margin: 4px 0 0; font-size: 12px; color: #475569;">${storeAddress}</p>
        </div>
        <div style="display: flex; justify-content: space-between; font-size: 11px; font-weight: bold; margin-bottom: 15px; color: #334155;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <thead>
            <tr>
              <th style="background: #0f172a; color: #ffffff; padding: 10px 8px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px;">Rank</th>
              <th style="background: #0f172a; color: #ffffff; padding: 10px 8px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; text-align: left;">Customer Name</th>
              <th style="background: #0f172a; color: #ffffff; padding: 10px 8px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; text-align: left;">Mobile</th>
              <th style="background: #0f172a; color: #ffffff; padding: 10px 8px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px;">Bills</th>
              <th style="background: #0f172a; color: #ffffff; padding: 10px 8px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; text-align: right;">Total Shopping</th>
              <th style="background: #0f172a; color: #ffffff; padding: 10px 8px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px; text-align: right;">Avg Bill</th>
              <th style="background: #0f172a; color: #ffffff; padding: 10px 8px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px;">Last Purchase</th>
              <th style="background: #0f172a; color: #ffffff; padding: 10px 8px; font-size: 10px; text-transform: uppercase; letter-spacing: 0.5px;">Tier</th>
            </tr>
          </thead>
          <tbody>
            ${rowsHtml}
        ...
        <div style="margin-top: 30px; text-align: center; font-size: 10px; color: #64748b; border-top: 1px solid #cbd5e1; padding-top: 10px;">
          Generated by Smart Fashion Manager Concierge System
        </div>
      </div>
    `;

    void printInCurrentDocument(fullReportHtml, `Top Customers Report - ${storeName}`);
  };
