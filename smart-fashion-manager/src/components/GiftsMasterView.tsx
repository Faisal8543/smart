...
export const GiftsMasterView: React.FC = () => {
  ...
  const handlePrintBarcodeLabels = () => {
    ...
    const printableHtml = `
      <div id="barcode-direct-print-area" style="font-family: 'Poppins', sans-serif; display: flex; flex-wrap: wrap; padding: 10px; background: white;">
        ${labelsHTML}
      </div>
    `;

    void printInCurrentDocument(printableHtml, `Print Gift Labels - ${selectedGift.name}`);
